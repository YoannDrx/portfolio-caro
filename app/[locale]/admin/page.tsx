...
import {
  ...
  DashboardWrapper,
  StatsGrid,
} from '@/components/admin/dashboard/dashboard-wrapper'
...
export default async function AdminDashboardPage({
  ...
  return (
    <DashboardWrapper>
      ...
      <DashboardHeader
        title="Dashboard"
        description="Vue d'ensemble de votre contenu et activité"
      />
      ...
      <DashboardSection className="grid gap-6 lg:grid-cols-3">
        {/* Site Health */}
        <AnimatedCardWrapper delay={0}>
          <Card className="h-full border-[var(--brand-neon)]/20 bg-black transition-all duration-300 hover:border-[var(--brand-neon)]/40 hover:shadow-[0_0_30px_rgba(213,255,10,0.1)]">
            <CardHeader>
          ...
          <Card className="h-full border-[var(--brand-neon)]/20 bg-black transition-all duration-300 hover:border-[var(--brand-neon)]/40 hover:shadow-[0_0_30px_rgba(213,255,10,0.1)]">
            ...
            <CardContent className="space-y-3">
              <Link href={`/${locale}/admin/projets/nouveau`} className="block">
                <Button
                  className="w-full justify-start gap-2 bg-[var(--brand-neon)] text-black transition-all duration-200 hover:scale-[1.02] hover:bg-[var(--neon-400)] hover:shadow-[0_0_20px_rgba(213,255,10,0.3)]"
                  size="lg"
                >
              ...
              <Link href={`/${locale}/admin/compositeurs/nouveau`} className="block">
                <Button
                  variant="outline"
                  className="w-full justify-start gap-2 border-white/20 text-white transition-all duration-200 hover:scale-[1.02] hover:border-[var(--brand-neon)]/50 hover:bg-white/5"
                  size="lg"
                >
