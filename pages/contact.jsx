        ...
        <Div className="container">
          <Div className="row">
            <Div className="col-lg-6">
              <SectionHeading title="Parlez moi de votre projet." subtitle="Disponibilité et réactivité" />
              <Spacing lg="55" md="30" />
            ...
            <Div className="col-lg-6">
              <form id="myForm" ref={form} onSubmit={sendEmail} className="row">
                ...
                <Div className="col-sm-12">
                  ...
                  <textarea type="text" name="message" cols="30" rows="7" className="cs-form_field"></textarea>
                  <Spacing lg="25" md="25" />
                </Div>
                <Div className="col-sm-12">
