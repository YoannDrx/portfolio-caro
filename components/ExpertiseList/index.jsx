  ...
  useEffect(() => {
    const loadExpertiseData = async () => {
      try {
        ...
        setExpertiseData(data.expertises); // Assurez-vous d'utiliser la clé correcte pour accéder aux données
      } catch (error) {
            ...
            <>
              <Div className="cs-image_layer cs-style1 cs-size_md">
                <Div className="cs-image_layer_in">
                  <img src={item.imgUrl} alt="Thumb" className="w-100 cs-radius_15" />
                </Div>
              </Div>
